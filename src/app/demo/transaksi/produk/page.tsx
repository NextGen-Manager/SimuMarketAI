  ...
  return (
    <main className="mx-auto max-w-[1180px] px-4 py-6 sm:px-6 xl:px-8 xl:py-8">
      ...
      <section aria-labelledby="catalog-title" className="mt-5 overflow-hidden rounded-[14px] border border-line bg-surface">
        <div className="flex flex-col gap-3 border-b border-line px-5 py-4 sm:flex-row sm:items-center sm:justify-between"><div><h2 id="catalog-title" className="text-[15px] font-bold text-ink-900">Produk {business.name}</h2><p className="mt-1 text-[11px] text-ink-400">{business.area}</p></div><span className="rounded-full border border-line bg-surface-2 px-2.5 py-1 text-[10px] font-bold text-ink-500">Katalog terpilih</span></div>
